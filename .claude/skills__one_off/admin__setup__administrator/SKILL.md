...
- `mingzilla/up-skill` - this project (installer + client skill)
- one **address book** repo per team
- one **sharing repo** per member (`up-skill__sharing__<member>`)
...
2. Help each member create their own sharing repo on their github account - guide them through `assets/up-skill__sharing_repo__setup_instructions.md`, then add the repo URL they send you to the address book.
