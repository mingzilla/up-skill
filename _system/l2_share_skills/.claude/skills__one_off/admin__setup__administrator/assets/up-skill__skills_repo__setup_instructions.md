# up-skill sharing repo - setup instructions
...
the member tells Claude "use up-skill to share X", Claude copies X into this repo and uploads it;
...
The member does not need to put anything in the repo now - the up-skill "share" verb uploads to it
